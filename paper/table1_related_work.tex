\begin{table}[t]
\centering
\caption{Prior empirical SBOM-quality studies and CRA-relevant regulatory analyses (P1--P25). For each study we report the benchmark used to measure SBOM quality or compliance, and its relationship to the CRA (cited as motivating context, full regulatory analysis without an SBOM corpus, or requirements framing). No prior study uses CRA Annex~I itself as the measurement benchmark against an SBOM corpus.}
\label{tab:related-work}
\scriptsize
\begin{tabular}{p{0.04\textwidth}p{0.27\textwidth}p{0.34\textwidth}p{0.27\textwidth}}
\toprule
...
P6 & O'Donoghue et al., SCORED@CCS 2024 \cite{odonoghue2024} & None (vulnerability-detection impact) & --- \\
